...
VALUES ('20230320153330_InitialCreate', '7.0.4');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20230331070750_IdentityAdded', '7.0.4');
...
CREATE TABLE "ActivityAttendees" (
    ...
    CONSTRAINT "PK_ActivityAttendees" PRIMARY KEY ("AppUserId", "ActvityId"),
    CONSTRAINT "FK_ActivityAttendees_Activities_ActvityId" FOREIGN KEY ("ActvityId") REFERENCES "Activities" ("Id") ON DELETE CASCADE,
    CONSTRAINT "FK_ActivityAttendees_AspNetUsers_AppUserId" FOREIGN KEY ("AppUserId") REFERENCES "AspNetUsers" ("Id") ON DELETE CASCADE
);

CREATE INDEX "IX_ActivityAttendees_ActvityId" ON "ActivityAttendees" ("ActvityId");

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20230404095031_ActivityAttendee', '7.0.4');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20230405063410_AddCancelledProperty', '7.0.4');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20230406175117_PhotoEntityAdded', '7.0.4');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20230414065835_CommentEntityAdded', '7.0.4');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20230417104034_AddedFollowingEntity', '7.0.4');
